...
- BIZ-307의 `memory_items`는 후속 Admin UI/API가 사용할 DB-backed 장기기억
  read model이다. Phase 1에서는 이 sidecar의 merge/decay/promotion 책임을
  제거하지 않고, 검토 완료 항목을 안정적인 id 기반 저장소로 옮길 기반만 둔다.
