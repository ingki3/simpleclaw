...
/**
 * Modal — Secrets 영역의 AddSecret / RotateConfirm 이 공유하는 wrapper.
 *
 * cron / memory / skills-recipes 의 Modal 과 동일한 시각 spec — admin.pen 의
 * 라운드 카드 + 검은색 50% 백드롭 + 우상단 X · 우하단 액션 행. 영역 간 경량
 * 중복을 허용하되, 시각이 어긋나지 않도록 토큰만 사용하도록 강제한다
 * (DESIGN.md §1 Principle 2).
 *
...
interface ModalProps {
  ...
  title: ReactNode;
  /** 우하단 액션 행 — 취소/실행 등의 Button 들. */
  footer: ReactNode;
  /** 좌하단 부가 액션. */
  footerLeft?: ReactNode;
  /** 카드 폭 — admin.pen 모달들이 520px / 720px 두 종류. */
  width?: "sm" | "md" | "lg";
  /** Rotate 다이얼로그용 — 스크린리더가 alertdialog 로 인지하도록 (DESIGN.md §10.2). */
