...
/**
 * Modal — Skills & Recipes 의 Retry Policy 인라인 편집 modal 등이 공유하는 wrapper.
 *
 * llm-router 의 Modal 과 동일한 시각 spec — admin.pen 의 라운드 카드 + 검은색 50% 백드롭 +
 * 우상단 X · 우하단 액션 행. 두 영역 간 경량 중복을 허용하되, 시각이 어긋나지 않도록
 * 토큰만 사용하도록 강제한다 (DESIGN.md §1 Principle 2).
 *
